...
export default function AddApplication() {
    ...
    return (
        <section className="w-full bg-blue-200 dark:bg-gray-900 transition-all duration-500 ease-in-out flex flex-col min-h-screen items-center">
            <div className="flex flex-col gap-5 justify-center items-center mt-10 border border-black/30 p-5 min-h-1/2 w-[80%] lg:w-1/2 rounded-lg bg-white/30 dark:bg-white/10 dark:border-white/30 backdrop-blur-md shadow-lg hover:backdrop-blur-2xl text-black dark:text-white transition-all duration-300 ease-in-out">
            ...
            <form onSubmit={(event)=>handleSubmit(event)} className="flex w-full flex-col flex-wrap gap-5 text-black transition-all duration-500 dark:text-white" key={id ?? "new-application"}>
            <label htmlFor="company-name" className="text-sm md:text-[16px]">Company Name: 
            ...
            <label htmlFor="role" className="text-sm md:text-[16px]">Role / Position: 
            ...
            <label htmlFor="location" className="text-sm md:text-[16px]">Location:
            ...
            <label htmlFor="application-date" className="text-sm md:text-[16px]">Application Date: 
            ...
            <label htmlFor="status" className="text-sm md:text-[16px]">Status:
            ...
            <label htmlFor="job-link" className="text-sm md:text-[16px]">Job Link: 
            ...
            <label htmlFor="notes" className="text-sm md:text-[16px]">Notes: 
            ...
            {error && <p className="text-sm md:text-[16px] text-red-600 font-semibold text-center dark:text-red-400" role="alert" aria-live="polite">{error}</p>}
